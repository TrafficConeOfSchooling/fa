...
local StructureUnitOnStartBeingBuiltRotateBuildings = categories.ROTATION360
-- Structures that rotate in 90 degree steps: T2/T3/T4 Artillery
local StructureUnitRotateStaticArty = categories.ROTATION90 -- These always point towards map center and only rotate at 90degree steps
