...
categories = {
    ...
    ROTATION360 = categoryValue, -- Causes structure to rotate freely towards nearest enemy on spawn
    ROTATION90 = categoryValue, -- Causes structure to rotate towards center of the map on spawn in 90 degree steps
